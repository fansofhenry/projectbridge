...
export default function ProjectDetailPage() {
  ...
  const canJoin = project.status === "recruiting" || project.status === "in_progress";
  const spotsLeft = project.max_collaborators - (project.members?.length ?? 0);
          ...
          <div className="bg-white border border-cloud rounded-card p-6 md:p-8 mb-6">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-slate border-t border-cloud pt-4">
              ...
              <span className="flex items-center gap-1.5">
                ...
                members
                {canJoin && spotsLeft > 0 && (
                  <span className="text-green-600 font-medium">· {spotsLeft} spot{spotsLeft !== 1 ? "s" : ""} open</span>
                )}
              </span>
              <span className="flex items-center gap-1.5">
            ...
            <div className="space-y-4">
              ...
              {canJoin && (
                <div className="bg-white border-2 border-amber-400 rounded-card p-5">
                  ...
                  {spotsLeft > 0 && (
                    <p className="text-[11px] text-center text-slate/60 mt-2">
